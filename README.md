...
本仓库是基于 [原始开源项目](https://github.com/original/vnpy) 的二次开发增强版本。
...
**原始项目**: https://github.com/original/vnpy
...
本项目是基于 [vnpy/vnpy](https://github.com/vnpy/vnpy) 的二次开发增强版本。
...
**原始项目**: [vnpy/vnpy](https://github.com/vnpy/vnpy)
